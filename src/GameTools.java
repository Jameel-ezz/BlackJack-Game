...
public class GameTools extends JComponent implements MouseListener {//this class will implement the MouseListener because we will check if the user clicked a certain coordinate on the component.
    ...
    public GameTools(ArrayList<Card> dH, ArrayList<Card> pH) { //this will be the constructor for this class which will accept two hands as a parameter.
        dealerHand = dH; //we initalize the instant fields.
        playerHand = pH;
        dealerScore = 0; //the scores start as 0.
        playerScore = 0;
        currentBalance = 500; //the balance starts as 1000.
    ...
    public void paintComponent(Graphics g) {
        ...
        try {
            ...
            chip = ImageIO.read(new File("Pictures/img.png")); //we read a file which is the png image of a poker chip for the chip on the poker table.
        ...
        g2.setColor(Color.GREEN); //we set the colors.
    ...
    public void mousePressed(MouseEvent e) {//in this void method, we will control mouse events of the user.
        ...
        if(mouseX>= 50 && mouseX<=200 && mouseY>=300 && mouseY<=450) {//we will only do something if the x and y coordinates fall on top of the chip image. The coordinates you see below give the end points of the chip image.
            ...
            //we then play this music which gives you the sound of poker chips settling on a poker table.
            Main.newGame.startGame(); //then we start the game.
        }
